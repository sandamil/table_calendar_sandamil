...
class CalendarController {
  ...
  DateTime _previousFirstDay = DateTime.now();
  DateTime _previousLastDay = DateTime.now();
  int _pageId = 0;
  double _dx = 0;
  bool _useNextCalendarFormat = false;
  bool _includeInvisibleDays = false;
  ...
  void swipeCalendarFormat({bool isSwipeUp = false}) {
  ...
  DateTime _getFirstDay({bool includeInvisible = false}) {
  ...
  DateTime _getLastDay({bool includeInvisible = false}) {
    if (_calendarFormat.value == CalendarFormat.month && !includeInvisible) {
